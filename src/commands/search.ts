...
import {callTraktSearch, type TraktType, type SearchItem, TrackN8NResponse} from "../integrations/n8n.js";
...
export default {
  ...
  execute: async function (interaction) {
    ...
    try {
      const response = (await callTraktSearch(query, type)) as TrackN8NResponse;
