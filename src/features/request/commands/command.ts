...
import {
  ...
  getDetails,
  pickDefaultSeasons,
} from '../../../core/integrations/jellyseerr.js';
import type { SlashCommand } from '../../../core/types/commands.js';
import type { SearchItem } from '../../../core/types/n8n.js';
import { getErrorMessage } from '../../../core/utils/errors.js';
import { getForThread, getForChannel } from '../../search/searchCache.js';
  ...
  async execute(interaction) {
    ...
    try {
      if (item.type === 'movie') {
        ...
        await handleTvRequest(interaction, item, tmdb, seasonsInput);
      }
    } catch (error: unknown) {
...
async function handleTvRequest(
